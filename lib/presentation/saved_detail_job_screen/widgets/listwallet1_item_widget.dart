...
class Listwallet1ItemWidget extends StatelessWidget {
  Listwallet1ItemWidget(this.listwallet1ItemModelObj);

  Listwallet1ItemModel listwallet1ItemModelObj;
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                listwallet1ItemModelObj.salaryTxt,
            ...
            Padding(
              ...
              child: Text(
                listwallet1ItemModelObj.priceTxt,
                overflow: TextOverflow.ellipsis,
                textAlign: TextAlign.left,
